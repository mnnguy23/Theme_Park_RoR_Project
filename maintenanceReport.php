...
function inputDateQuery() {
  $query = "SELECT DISTINCT E.e_name, A.a_name, M.breakdown_date, M.maintenance_cost FROM employee AS E, attraction AS A, attraction_maintenance AS M WHERE  M.am_id=A.attraction_id;";
